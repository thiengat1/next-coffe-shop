    ...
    <div className='py-6 mx-10'>
      <nav className='flex flex-row justify-between items-center relative'>
        ...
        <ul
          ...
          }  lg:flex basis-3/6 lg:items-center lg:justify-end lg:gap-8 uppercase text-sm text-gray-500 font-medium`}
        >
        ...
        <ul className='basis-3/6 lg:basis-1/6 flex justify-end lg:justify-start items-center ml-16 text-sm text-gray-500 font-medium uppercase'>
          <li>
        ...
        <div className='lg:hidden basis-1/6 flex items-center px-2 sm:px-4  cursor-pointer'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
            viewBox='0 0 24 24'
